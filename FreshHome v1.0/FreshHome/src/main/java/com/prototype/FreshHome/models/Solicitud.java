...
public class Solicitud {
	...
	public Solicitud(String idSolicitud, String descripcion, LocalDate fechaSolicitud, String nombreCliente,
			String direccionCliente, double tarifa, String idCliente, String idEmpleado, String idHabilidad,
			int calificacionCliente, String observacionCliente, int calificacionEmpleado, String observacionEmpleado) {
		super();
